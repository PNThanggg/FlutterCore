  ...
  void onStopButtonPressed() {
    stopVideoRecording().then((XFile? file) async {
      ...
      if (file != null) {
        ...
        final String newFileName = path.join(tempDir.path, '${DateTime.now().millisecondsSinceEpoch}.mp4');
        ...
        await GallerySaver.saveVideo(
          ...
          (value) {
            if (value != null) {
              if (value) {
                showInSnackBar("Save video success");
              } else {
                showInSnackBar("Save video failed");
              }
            } else {
              showInSnackBar("Save video result::NULL");
            }
          },
        );
